...
public class LineChartActivity extends ActionBarActivity {
	...
	public static class PlaceholderFragment extends Fragment {
		...
		private boolean onlyMaxMinPoints = true;
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			chart = new LineChartView(rootView.getContext(), Color.GREEN,
					Color.YELLOW);
			RelativeLayout rl_chart = (RelativeLayout) rootView
					.findViewById(R.id.rl_chart);
			rl_chart.addView(chart);
		...
		private void generateData() {
			...
			values.add(new PointValue(0, 5.664166666666667f));
			values.add(new PointValue(1, 235.45388888888888f));
			values.add(new PointValue(2, 227.04638888888888f));
			values.add(new PointValue(3, 229.21583333333334f));
			values.add(new PointValue(4, 229.12916666666666f));
			values.add(new PointValue(5, 251.3347222222222f));
			values.add(new PointValue(6, 26.59777777777778f));
			values.add(new PointValue(7, 134.13444444444445f));
			values.add(new PointValue(8, 318.0588888888889f));
			...
			line.setAreaTransparency(1000);
			line.setOnlyMaxMinPoints(onlyMaxMinPoints);
