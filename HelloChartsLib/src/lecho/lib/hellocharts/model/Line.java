...
public class Line {
	...
	private boolean onlyMaxMinPoints;
	...
	public boolean onlyMaxMinPoints() {
		return onlyMaxMinPoints;
	}

	public Line setOnlyMaxMinPoints(boolean onlyMaxMinPoints) {
		this.onlyMaxMinPoints = onlyMaxMinPoints;
		return this;
	}
