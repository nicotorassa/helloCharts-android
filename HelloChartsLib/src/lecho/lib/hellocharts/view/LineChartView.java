...
import lecho.lib.hellocharts.samples.BuildConfig;
 ...
 * Point radius and stroke width can be adjusted using LineChartData attributes.
 * 
 * @author Leszek Wach
 */
public class LineChartView extends AbstractChartView implements
	...
	public LineChartView(Context context,int botColor, int topColor) {
		this(context, null, 0, botColor, topColor);
	}
	...
	public LineChartView(Context context, AttributeSet attrs, int defStyle,
			int botColor, int topColor) {
		super(context, attrs, defStyle);
		setChartRenderer(new LineChartRenderer(context, this, this, botColor,
				topColor));
	...
	public void setOnValueTouchListener(
			LineChartOnValueSelectListener touchListener) {
